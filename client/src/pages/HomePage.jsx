            ...
            <div className="general">
                ...
                <div className="homepage">
                    <div className="row">
                        ...
                        <img className="homepage-picture" src={park} alt='stuff'/>
                    </div>
                    
                    <div className="row">
                        <img className="homepage-picture" src={dogs} alt='stuff'/>
                    ...
                    <div className="row">
                        ...
                        <img className="homepage-picture" src={kitten} alt='stuff'/>
                    </div>

                    <div className="row">
                        <img className="homepage-picture" src={fetch} alt='stuff'/>
                    ...
                    <div className="row">
                        ...
                        <img className="homepage-picture" src={cats} alt='stuff'/>
                    </div>
